...
var _ Girl = &Panjinlian{}

func (p *Panjinlian) MakeEyes() {
	fmt.Println("潘金莲 抛了一个媚眼")
}
func (p *Panjinlian) Happy() {
	fmt.Println("潘金莲 嗨皮了一下")
}
...
func NewProxy(girl Girl) WangPo {
	return WangPo{girl}

}

// 代理的具体
func (w *WangPo) MakeEyes() {
	w.girl.MakeEyes() // 用手里的资源去做
}
func (w *WangPo) Happy() {
	w.girl.Happy() // 用手里的资源去做
}

// ###### 业务层
func main() {
	// 西门大官人 想让王婆安排
	wangPo := NewProxy(new(Panjinlian)) // 王婆 和 金莲 都属于 Girl 才能代理
